import { 
    ...
    Field as VeeField,
    defineRule,
    ErrorMessage, configure } from "vee-validate";
import { required, 
    min, 
    max, 
    ...
    max_value as maxVal,
    confirmed,
    not_one_of as excluded } from "@vee-validate/rules";
        ...
        configure({
            generateMessage: (ctx) => {
                const messages = {
                    ...
                    excluded: `You are not allowed to use this value for tha field ${ctx.field}.`,
                    countryExcluded: `Due to restrictions, we do not accept users from this locations.`,
